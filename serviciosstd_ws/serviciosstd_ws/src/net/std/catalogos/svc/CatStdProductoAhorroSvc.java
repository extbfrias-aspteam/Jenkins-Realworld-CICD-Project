...
@Controller
public class CatStdProductoAhorroSvc implements Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger log = LogManager.getLogger(CatStdProductoAhorroSvc.class);
	...
	@RequestMapping(value="/catProductoAhorroStd", method=RequestMethod.POST)
	public ResponseEntity<String> catProductoAhorroStd(@RequestBody String json){
		...
		try{
			...
			RespuestaSVC respuesta = dao.catProductoAhorroStdDao(clave);
