...
@Controller
public class TraLoggerSvc implements Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger log = LogManager.getLogger(TraLoggerSvc.class);
	...
	@RequestMapping(value="/traLoggerStd", method=RequestMethod.POST)
	public ResponseEntity<String> traLoggerStd(@RequestBody String json){
		...
		try{
			RespuestaSVC respuestaSvc = dao.insertarbitacoraTraDao(map);
