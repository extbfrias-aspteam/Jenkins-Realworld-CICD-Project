...
@Controller
public class SpeiIncomingSvc implements Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger log = LogManager.getLogger(SpeiIncomingSvc.class);
	...
	@RequestMapping(value="/datosIncomingStd", method=RequestMethod.POST)
	public ResponseEntity<String> tipoPagoSpei(@RequestBody String json){
		SecurityContext securityContext = SecurityContextHolder.getContext();
		ResponseEntity<String> response = null;
		Map<String, String> map;
		log.info(String.format("/datosIncomingStd :: %s", json));
		...
		try{
			RespuestaSVC respuestaSvc = dao.consultaIncomingPorCveRastreoStdDao(map);
