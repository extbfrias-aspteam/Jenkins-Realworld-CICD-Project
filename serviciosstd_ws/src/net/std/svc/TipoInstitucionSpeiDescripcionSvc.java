...
@Controller
public class TipoInstitucionSpeiDescripcionSvc implements Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger log = LogManager.getLogger(TipoInstitucionSpeiDescripcionSvc.class);
	...
	@RequestMapping(value="/tipoInstitucionSpeiDescripcion", method=RequestMethod.POST)
	public ResponseEntity<String> tipoInstitucionSpeiDescripcion(@RequestBody String json){
		SecurityContext securityContext = SecurityContextHolder.getContext();
		ResponseEntity<String> response = null;
		Map<String, String> map;
		log.info(String.format("/tipoInstitucionSpeiDescripcion :: %s", json));
		...
		try{
			RespuestaSVC respuestaSvc = dao.leerInstitucionSpeiDescripcionDao(Comun._T(map.get("valor")));
