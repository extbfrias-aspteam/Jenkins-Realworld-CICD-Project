 ...
 */
public class CajaDepositoAhorro {
	private static final Logger log = LogManager.getLogger(CajaDepositoAhorro.class);
	...
	public Respuesta registrarDeposioto(CajaDepositoAhorroReq req){
		...
		if(vMovimientoCaja == null){
			...
			if(ahorroMovimiento.getSalvoBuenCobro() == null){
				ahorroActualizasaldo(req.getFecha(),req.getCuentaAhorro(), req.getMonto(), ahorroMovimiento.getOperacion());
			}else{
			...
			movimientoCajaExistente.setModificadoPor((int) req.getHeader().getIdUsuario());
