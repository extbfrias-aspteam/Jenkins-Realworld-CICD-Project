...
public class CloudSqlConnectionPool {
	public static DataSource createConnectionPool(String dbUser, String dbPass, String dbName,
	    ...
	    config.setMaximumPoolSize(3); // ajusta según tu carga esperada
	    config.setMinimumIdle(1);     // conexiones mínimas que se mantienen activas
	    config.setIdleTimeout(35000);       // 35 segundos
