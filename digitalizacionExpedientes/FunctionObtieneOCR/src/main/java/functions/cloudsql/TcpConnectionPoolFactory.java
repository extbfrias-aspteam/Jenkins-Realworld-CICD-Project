 ...
 * Banco ASP
 * Project: eiyu
 * Class: TcpConnectionPoolFactory.java
 *
 * Description:
 *
 * @author Herwin TR
 ...
 * @version 1.0 Oct 4, 2023 Herwin: Creacion de la clase
 *
 * @category 
 *
 */
...
//	private static final String SSL_SERVER_CA_PATH = System.getenv("SSL_SERVER_CA_PATH");
	...
	public static DataSource createConnectionPool() {
		...
		config.setJdbcUrl(String.format("jdbc:postgresql://%s:%s/%s?useSSL=false", INSTANCE_HOST, DB_PORT, DB_NAME));
		...
		// See the link below for more information on how to configure SSL Certificates
		// for use with
...
//		}
		...
		// [END_EXCLUDE]
		System.out.println("Retorna la configuracion del pool");
