...
public class IneOcrRespOBJ implements Serializable {
	...
	private String identificadorCiudadano; // Identificador ciudadano
	...
	private ValidacionesMRZ validacionMRZ;
	...
	public IneOcrRespOBJ(String primerApellido, String segundoApellido, String nombres, String calle, String colonia,
			...
			String mensaje, String identificadorCiudadano) {
		super();
	 ...
	 * @param estatus
	 * @param mensaje
	 * @param validacionesMRZ
	 */
	public IneOcrRespOBJ(String primerApellido, String segundoApellido, String nombres, String calle,
			String colonia, String ciudad, String edad, String fechaNacimiento, String identificadorCiudadano,
			String sexo, String folio, String claveElector, String curp, String estado, String municipio,
			String distrito, String localidad, String seccion, String emision, String vigencia, String ocr, String cic,
			String codigoValidacion, String estatus, String mensaje, ValidacionesMRZ validacionMRZ) {
		super();
		this.primerApellido = primerApellido;
		this.segundoApellido = segundoApellido;
		this.nombres = nombres;
	...
	public ValidacionesMRZ getValidacionMRZ() {
		return validacionMRZ;
	}

	public void setValidacionMRZ(ValidacionesMRZ validacionMRZ) {
		this.validacionMRZ = validacionMRZ;
	}

	@Override
	public String toString() {
		return "IneOcrRespOBJ [primerApellido=" + primerApellido + ", segundoApellido="
				+ segundoApellido + ", nombres=" + nombres + ", calle=" + calle + ", colonia=" + colonia + ", ciudad="
				+ ciudad + ", edad=" + edad + ", fechaNacimiento=" + fechaNacimiento + ", identificadorCiudadano="
				+ identificadorCiudadano + ", sexo=" + sexo + ", folio=" + folio + ", claveElector=" + claveElector
				+ ", curp=" + curp + ", estado=" + estado + ", municipio=" + municipio + ", distrito=" + distrito
				+ ", localidad=" + localidad + ", seccion=" + seccion + ", emision=" + emision + ", vigencia="
				+ vigencia + ", ocr=" + ocr + ", cic=" + cic + ", codigoValidacion=" + codigoValidacion + ", estatus="
				+ estatus + ", mensaje=" + mensaje + ", validacionesMRZ=" + validacionMRZ + "]";
	}
