 ...
 *
 */
public class BloquearTemporalSoapServiciosSW {
	private static final Logger log = LogManager.getLogger(BloquearTemporalSoapServiciosSW.class);

	public static RespuestaSVC BloquearTemporal(PlaHeaderWS header, DatosPlasticoREQ pla) {
		...
		try{
			...
			pla.setTipoOperacion(1);  //1 = bloqueo
