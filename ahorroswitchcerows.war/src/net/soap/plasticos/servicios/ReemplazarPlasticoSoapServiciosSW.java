...
import net.cero.plastico.reemplazarplastico.ReemplazarPlasticoIfz;
import net.cero.plastico.reemplazarplastico.ReemplazarPlasticoIfzService;
import net.cero.plastico.reemplazarplastico.ReemplazarPlasticoRequest;
import net.cero.plastico.reemplazarplastico.ReemplazarPlasticoResponse;
 ...
 *
 */
public class ReemplazarPlasticoSoapServiciosSW {
	private static final Logger log = LogManager.getLogger(ReemplazarPlasticoSoapServiciosSW.class);

	public static RespuestaSVC ReemplazarPlastico(PlaHeaderWS header, DatosPlasticoREQ pla) {
		RespuestaSVC respuestaSvc = new RespuestaSVC();
		URL wsdl = null;
		DatosPlasticoOBJ obj = null;

		try{
			wsdl = new URL(ReemplazarPlasticoIfzService.WSDL_LOCATION.toString().replace("localhost", Constantes.SERVICIOS_SISCOOP));
		}catch(Exception ex){
			log.error(ex);
		...
		try{
			ReemplazarPlasticoIfzService service1 = new ReemplazarPlasticoIfzService(wsdl);
			ReemplazarPlasticoIfz port1 = service1.getReemplazarPlasticoIfzPort();

			ReemplazarPlasticoRequest req = new ReemplazarPlasticoRequest();
			req.setHeader(header);
			req.setDatosPlasticoREQ(pla);
			ReemplazarPlasticoResponse response = port1.procesar(req);
