...
import net.cero.ahorroProcrea.servicios.ServiciosCajaDepositoPrWS;
import net.cero.ahorroProcrea.servicios.ServiciosCajaDisposicionPrWS;
...
@Controller
public class ProcesoCajaDepositoAhorroPrSW implements Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger log = LogManager.getLogger(ProcesoCajaDepositoAhorroPrSW.class);

	@Autowired
	protected IPAuthenticationProvider authenticationManager;

	@RequestMapping(value="/procesoCajaDepositoAhorroPrSW", method=RequestMethod.POST)
	public ResponseEntity<String> procesoCajaDepositoAhorroPrSW(@RequestBody String json){
		...
		try{
			respuestaSvc = ServiciosCajaDepositoPrWS.cajaDepositoAhorroPrSW(map);
