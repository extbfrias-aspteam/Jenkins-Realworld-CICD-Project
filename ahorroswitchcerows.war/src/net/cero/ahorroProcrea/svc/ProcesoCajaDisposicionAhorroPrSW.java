...
@Controller
public class ProcesoCajaDisposicionAhorroPrSW implements Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger log = LogManager.getLogger(ProcesoCajaDisposicionAhorroPrSW.class);

	@Autowired
	protected IPAuthenticationProvider authenticationManager;

	@RequestMapping(value="/procesoCajaDisposicionAhorroPrSW", method=RequestMethod.POST)
	public ResponseEntity<String> procesoCajaDisposicionAhorroPrSW(@RequestBody String json){
		...
		try{
			respuestaSvc = ServiciosCajaDisposicionPrWS.cajaDisposicionAhorroPrSW(map);
