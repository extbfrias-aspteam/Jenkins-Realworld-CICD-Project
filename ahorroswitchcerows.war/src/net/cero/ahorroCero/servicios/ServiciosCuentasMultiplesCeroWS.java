package net.cero.ahorroCero.servicios;
...
public class ServiciosCuentasMultiplesCeroWS implements Serializable {
	private static final long serialVersionUID = 1L;
	private static Logger log = LogManager.getLogger(ServiciosCuentasMultiplesCeroWS.class);

	public static RespuestaSVC leerCuentaMultipleAhorroCeroSW(Map<String, Object> map) {
		RespuestaSVC respuestaSvc = new RespuestaSVC();
		Gson gson = ToolsR.GBuilder();
		String uri = new StrBuilder(Constantes.AHORRO_SIMPLIFICADA_WS).append("/").append("leerCuentaMultipleAhorroCeroCS").toString();
		log.info(uri);
		...
		try{
			...
			respuestaSvc.getErrores().addCodigo("GENERICO", Errores.ERROR_INESPERADO, "leerCuentaMultipleAhorroCeroSW");
		}
		return respuestaSvc;
	}
}
