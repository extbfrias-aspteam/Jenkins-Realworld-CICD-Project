...
public class ServiciosInsertaImportacionProcreaWS implements Serializable {
	private static final long serialVersionUID = 1L;
	private static Logger log = LogManager.getLogger(ServiciosInsertaImportacionProcreaWS.class);

	public static RespuestaSVC procesa(Map<String, Object> map) {
		RespuestaSVC respuestaSvc = new RespuestaSVC();
		Gson gson = ToolsR.GBuilder();
		String uri = new StrBuilder(Constantes.AHORRO_SIMPLIFICADA_WS).append("/").append("insertaImportacionCS").toString();
		log.info(uri);
