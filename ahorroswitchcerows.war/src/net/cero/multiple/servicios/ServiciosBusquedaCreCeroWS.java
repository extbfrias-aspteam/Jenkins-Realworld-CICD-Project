...
public class ServiciosBusquedaCreCeroWS implements Serializable {
	private static final long serialVersionUID = 1L;
	private static Logger log = LogManager.getLogger(ServiciosBusquedaCreCeroWS.class);

	public static RespuestaSVC procesa(Map<String, Object> map) {
		RespuestaSVC respuestaSvc = new RespuestaSVC();
		Gson gson = ToolsR.GBuilder();
		String uri = new StrBuilder(Constantes.AHORRO_SIMPLIFICADA_WS).append("/").append("busquedaCreCeroCS").toString();
		log.info(uri);
