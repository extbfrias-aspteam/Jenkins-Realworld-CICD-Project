...
public class ServiciosBusquedaAhoCeroWS implements Serializable {
	private static final long serialVersionUID = 1L;
	private static Logger log = LogManager.getLogger(ServiciosBusquedaAhoCeroWS.class);

	public static RespuestaSVC procesa(Map<String, Object> map) {
		RespuestaSVC respuestaSvc = new RespuestaSVC();
		Gson gson = ToolsR.GBuilder();
		String uri = new StrBuilder(Constantes.AHORRO_SIMPLIFICADA_WS).append("/").append("busquedaAhoCeroCS").toString();
		log.info(uri);
