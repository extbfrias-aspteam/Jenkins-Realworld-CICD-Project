...
@Service
@Log4j2
public class WsAspPagoManagement {
    ...
    public RespuestaDTO enviarPeticion(String pathEndPoint, Object object, HttpMethod method, Map<String, String> queryParams) {
        ...
        String url = InvokeRestServiceUtil.getURLRest(msManagementHost, msManagementPort, pathEndPoint);
    ...
    private String getAuthorizationHeader() {
        String auth = msManagementUser + ":" + msManagementPass;
