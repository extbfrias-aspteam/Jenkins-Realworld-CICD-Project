...
public class AspPagoApiStorageService {
    ...
    @Value("${ms.documents.upload.files.biometria.asppago}")
    private String pathSubeArchivosBiometriaAspPago;
    ...
    public String uploadFilesBiometriaAspPago(
        ...
        try {
            ...
            body.add("idpersona", identificador);
            ...
            respuestaDTO = wsAspPagoStorage.enviarPeticion(pathSubeArchivosBiometriaAspPago, body,
