...
@Service
@Log4j2
public class WsAspPagoPayments {
    @Value("${ms.payments.host}")
    private String msPaymentsHost;
    @Value("${ms.payments.port}")
    private String msPaymentsPort;
    @Value("${asp.pago.payments.user}")
    private String msPaymentsUser;
    @Value("${asp.pago.payments.pass}")
    private String msPaymentsPass;
    private final InvokeRestServiceUtil invokeRestServiceUtil;

    @Autowired
    public WsAspPagoPayments(InvokeRestServiceUtil invokeRestServiceUtil) {
    ...
    public RespuestaDTO enviarPeticion(String pathEndPoint, Object object, HttpMethod method, Map<String, String> queryParams) {
        ...
        String url = InvokeRestServiceUtil.getURLRest(msPaymentsHost, msPaymentsPort, pathEndPoint);
    ...
    private String getAuthorizationHeader() {
        String auth = msPaymentsUser + ":" + msPaymentsPass;
