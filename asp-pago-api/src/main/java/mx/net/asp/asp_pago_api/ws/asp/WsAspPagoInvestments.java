...
@Service
@Log4j2
public class WsAspPagoInvestments {
    @Value("${ms.investments.host}")
    private String msInvestmentsHost;
    @Value("${ms.investments.port}")
    private String msInvestmentsPort;
    @Value("${asp.pago.investments.user}")
    private String msInvestmentsUser;
    @Value("${asp.pago.investments.pass}")
    private String msInvestmentsPass;
    private final InvokeRestServiceUtil invokeRestServiceUtil;

    @Autowired
    public WsAspPagoInvestments(InvokeRestServiceUtil invokeRestServiceUtil) {
    ...
    public RespuestaDTO enviarPeticion(String pathEndPoint, Object object, HttpMethod method, Map<String, String> queryParams) {
        ...
        String url = InvokeRestServiceUtil.getURLRest(msInvestmentsHost, msInvestmentsPort, pathEndPoint);
    ...
    private String getAuthorizationHeader() {
        String auth = msInvestmentsUser + ":" + msInvestmentsPass;
